/* GLOBAL NEWS24 UNIVERSAL MEGA NAV v1.0 */
(function(){
'use strict';
...
function installBar(){
 ...
 var header=document.querySelector('.global-edition-header,.regional-site-header');if(!header)return;
 ...
 bar.innerHTML='<div class="gn24-universal-inner"><button class="gn24-universal-btn" data-kind="korea">대한민국 17개 ▼</button><button class="gn24-universal-btn" data-kind="world">GLOBAL 30 ▼</button></div><div class="gn24-universal-panel" hidden></div>';
